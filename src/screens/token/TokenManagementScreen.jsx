...
const inProgressPatientAtom = atom({
  ...
  patient_profile_picture_url: 'https://example.com/profile_pictures/johndoe.jpg',
  status: 'In Progress',
  token_id: 1,
  token_no: 1,
});
...
const TokenManagement = (props) => {
  ...
  const [inProgessPatient , setInProgressPatient] = useAtom(inProgressPatientAtom);
    ...
    <View style={styles.fullScreenContainer}>
      <ScrollView horizontal contentContainerStyle={styles.scrollContent}>
        <View>
          ...
          <InProgressTokenNotificationScreen inProgressPatient={inProgessPatient} />
        </View>
      </ScrollView>
    </View>
  );
